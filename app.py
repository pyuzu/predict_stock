...
st.write('あくまでAIによる予測です。こちらのアプリによる損害や損失は一切保証しかねます')
...
try:
    ...
    st.header(stock_name_full + "2020年1月1日から現在までの価格（USD）")
    st.write(df_stock)
...
st.write('Copyright ©　2021 Iguchi Yuzuka.All Rights Reserved.')
